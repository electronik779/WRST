...
Установка не требуется. Для Windows x64 скачайте "свежий" релиз [Windows-x64-WRST.zip](https://github.com/electronik779/WRST/releases), распакуйте в любую удобную для вас папку и запустите исполняемый файл (WRST.exe).
