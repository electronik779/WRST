...
Средний многолетний расход 133 м³/с. Значит паводок длится с 4-ого по 7-8-ой месяцы.

В седьмом месяце водохранилище точно будет заполнено, значит в поле **`Календарный месяц, с которого начинается расчетный ряд`** задаем - 7.
