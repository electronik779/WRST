...
Установка не требуется. Для Windows x64 скачайте файл WRST_2025.1.exe из раздела Releases ([WRST для Windows x64](https://github.com/electronik779/WRST/releases/tag/2025.1)) в любую удобную для вас папку и запустите.
