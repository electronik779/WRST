...
[Files]
; ---- СБОРКА ДЛЯ ARM64 ----
; Файлы будут копироваться только если процессор пользователя нативный ARM64
...
; ---- СБОРКА ДЛЯ X64 ----
; Файлы будут копироваться только если процессор стандартный Intel/AMD x64 (не ARM64)
