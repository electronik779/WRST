...
[Messages]
english.IDP_FormCaption=Downloading additional files
english.IDP_FormDescription=Please wait while setup downloads additional files...
english.IDP_DownloadFailed=Download failed
english.IDP_RetryCancel=Click Retry to try downloading files again, or Cancel to terminate setup.
english.IDP_Files=Files
english.IDP_Speed=Speed
english.IDP_Status=Status
english.IDP_ElapsedTime=Elapsed time
english.IDP_RemainingTime=Remaining time
english.IDP_TotalProgress=Total progress
english.IDP_Connecting=Connecting...
english.IDP_Downloading=Downloading...
english.IDP_DownloadComplete=Download complete
english.IDP_Initializing=Initializing...

russian.IDP_FormCaption=Скачивание дополнительных файлов
russian.IDP_FormDescription=Пожалуйста, подождите, пока программа скачает необходимые компоненты...
russian.IDP_DownloadFailed=Сбой скачивания
russian.IDP_RetryCancel=Нажмите "Повторить", чтобы попробовать снова, или "Отмена" для выхода из установки.
russian.IDP_Files=Файлы
russian.IDP_Speed=Скорость
russian.IDP_Status=Статус
...
russian.IDP_Downloading=Скачивание...
russian.IDP_DownloadComplete=Скачивание завершено
