...
Установка не требуется. Для Windows x64 скачайте "свежий" релиз ([WRST для Windows x64](https://github.com/electronik779/WRST/releases)) в любую удобную для вас папку и запустите.
